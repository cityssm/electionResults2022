...
define ([ "backbone", "jquery", "underscore",
    "app/collections/areatypeCollections", "app/utils/config", "app/utils/helper", "text!app/templates/error.html"],
    function(Backbone, $, _, areaTypeCollections, Config, Helper, ErrorTemplate){
        ...
        var Router = Backbone.Router.extend({
            ...
            initialize: function(){
                ...
                this.initRoute();
                if(Config.languages.length > 1) {setTimeout(addLanguageSelectionMenu, 1000);}
            },
            ...
            areaAndContest: function(atid, arid, ctid) {
                ...
                if(Helper.checkUpValue(atid)) {
                    $("div.areaType_nav").find("#" + atid).trigger('click');
                }
