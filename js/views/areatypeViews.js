...
define([
    ...
    "underscore",
    "backbone",
    "text!app/templates/areatype.html",
    "app/collections/areaCollections",
    "app/utils/helper",
    "app/utils/config"
    ...
    if (Config.isAreaTypeMenuVisible) {
        ...
        $("#menu_tab").append(
            '<a href="#" class="animated bounceInLeft"><img src="images/btnareatype.png"/></a>'
        );
    } else {
    ...
    Views.onClickButtonAreaTypeMenuShow = function () {
        ...
        Views.isAreaTypeMenuOpen
            ? (Views.isAreaTypeMenuOpen = false)
            : (Views.isAreaTypeMenuOpen = true);
    };
    ...
    Views.AreaTypeListView = Backbone.View.extend({
        ...
        render: function () {
            this.$el
                .append(Helper.template("areaTypeListTemplate", this.model.toJSON()))
