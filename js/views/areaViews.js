...
define([
    ...
    Views.AreaCollectionView = Backbone.View.extend({
        ...
        render: function () {
            ...
            if (Config.isAreaListEnterAnimationRepeated) {
                this.$el.removeClass("animated " + effect);
            }

            var areaCollection = new Backbone.Collection(
                this.collection.where({ areaTypeId: Views.selectedAreatypeID })
            );
            ...
            if (Config.isAreaListVisible) {
                if (
                    Config.isAreaListEnterAnimated &&
                    Helper.getScreenWidth() > Helper.MobileBreakpoint
                ) {
    ...
    Views.AreaListView = Backbone.View.extend({
        ...
        addArrowsAndLinks: function () {
            ...
            this.$el
                ...
                .attr(
                    "href",
                    "#at/" + Views.selectedAreatypeID + "/ar/" + Views.selectedAreaID + "/"
                );
            ...
            if (this.model.collection.length > 0 && Config.isChildAreaSubMenuVisible) {
                ...
                var subAreas = new Backbone.Collection(
                    this.model.collection.where({ parentAreaId: this.model.get("id") })
                );
                ...
                if (showSubAreaMenu) {
                    ...
                    var subAreaCollectionView = new Views.SubAreaCollectionView({
                        collection: subAreas
                    });
    ...
    Views.showContestForSelectedArea = function (target) {
        ...
        var urlWithAreaResults =
            Config.defaultURLprefix + Config.defaultAreaResultsFileName + ".json";

        if (Views.contestResultCollection) {
            Views.contestResultCollection.stopUpdate();
        }
        Views.contestResultCollection = new contestCollections.StatisticsCollection({
            url: urlWithAreaResults,
            selectedAreaID: showResultsForAreaWithID
        });
    ...
    Views.areaButtonClick = function (target, isSubLevel) {
        ...
        var closeSublevel = function () {
            ...
            if (openSublevel.length > 0) {
                openSublevel.removeClass("sublevel-open").slideToggle();
            }
        };
        ...
        var switchArrowImageDirection = function () {
            ...
            if (mainLevelOpenObject !== "") {
                ...
                while (i < 2) {
                    $thisTarget =
                        i === 0 && mainLevelOpenObject !== "" ? $(mainLevelOpenObject) : $target;
        ...
        var animateSelection = function () {
            if (Config.areaListItemAnimation > 0) {
                ...
                if (hasAnimationClass.length > 0) {
                    hasAnimationClass.removeClass().addClass("list-group-item");
                }
        ...
        render: function () {
            ...
            if (Views.selectedAreatypeID !== "") {
                this.$el
                    ...
                    .attr(
                        "href",
                        "#at/" + Views.selectedAreatypeID + "/ar/" + selectedSubareaID + "/"
                    );
            } else {
