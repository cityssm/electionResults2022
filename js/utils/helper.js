/* global define */
define(["jquery", "underscore", "app/utils/config"], function ($, _, Config) {
    "use strict";
    var Utils = {};
    Utils.Resources = "";
    ...
    Utils.loadLanguagePack = function () {
        ...
        function setResources(data) {
            ...
            if (Config["electionTitle" + lang] !== "") {
                Utils.Resources.electionTitle = Config["electionTitle" + lang];
            }
            if (Config["unofficialTitle" + lang] !== "") {
                Utils.Resources.unofficialTitle = Config["unofficialTitle" + lang];
            }
    ...
    Utils.addAndRemoveUpdateAlert = function ($obj) {
        var html =
            '<div id="updated" data-resourceId="updatedTitle" class="localize alert alert-success text-center animated flash">';
